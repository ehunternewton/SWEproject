...
def student_dashboard():
    cur = mysql.connection.cursor()
    cur.execute("SELECT AVG(cr.course_gpa) AS avg_gpa, cr.course_gpa, cr.exam_1, cr.exam_2, cr.final, cd.course_name, "
                "c.semester_name, u.first_name, u.last_name "
...
def update_grades(course_registration_id):
    ...
    if request.method == 'POST' and form.validate():
        ...
        if exam_1 is not None and exam_2 is not None and final is not None:
            # calculate GPA
